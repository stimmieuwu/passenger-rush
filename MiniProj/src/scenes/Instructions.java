...
/**
 * This class represents the "Instructions" scene in the application.
 * It displays instructions for the game and provides a button to return to the main menu.
 *
...
public class Instructions {
    ...
    /**
     * Constructs an Instructions object.
