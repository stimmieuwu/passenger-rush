...
/**
 * This class represents the main menu (splash screen) of the Passenger Rush
 * game. It provides buttons to navigate to different sections of the game, such
 * as instructions, about the developer, starting the game, and viewing the game
 * over screen.
 *
...
public class MainMenu {
	...
	/**
	 * Constructs a MainMenu object. Initializes the main menu scene with buttons
	 * for navigation and sets up their actions.
	 *
...
//		Main link = new Main();
	...
	private void assignStyleSheets() {
		splashScene.getStylesheets().add((getClass()).getResource("application.css").toExternalForm());
