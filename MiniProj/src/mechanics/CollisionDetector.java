...
public class CollisionDetector {
	...
	public boolean detectTile(Player player, KeyCode key, double dx, double dy) {
        ...
        Rectangle2D predictedHitbox = new Rectangle2D(player.collisionBox.getMinX() + dx, player.collisionBox.getMinY() + dy, 
                player.collisionBox.getWidth(), player.collisionBox.getHeight());
