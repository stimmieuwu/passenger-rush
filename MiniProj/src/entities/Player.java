...
public class Player extends Sprite {
	...
	private double dy;
	/** The predicted change in x-coordinate for collision detection. */
	private double predictDX;
	/** The predicted change in y-coordinate for collision detection. */
	...
	// Movement and collision related
	...
	/** Indicates if the player is currently colliding */
	public boolean isColliding;
	/** Indicates if the player's controls are flipped */
	...
	// Game attributes
	/** Amount of passengers the player has transported successfully */
	public int score;
	/** Amount of passenger the jeepney currently holds */
	...
	/**
	 * Activates a buff on the player.
	 *
	 * @param buffType The type of buff to activate
	 */
	...
	/**
	 * Deactivates a buff on the player.
	 *
	 * @param buffType The type of buff to deactivate
	 */
	...
	/**
	 * Generates the collision box for the player
	 *
	 * @return The Rectangle2D representing the collision box.
	 */
	...
	/**
	 * Generates the hitbox for the player based on its current position and image
	 * size.
	 *
	 * @return The `Rectangle2D` representing the hitbox.
	 */
	public Rectangle2D generateHitBox() {
		return new Rectangle2D(this.getXPos() + 30, this.getYPos() + 30, playerImage.getWidth() - 30,
				playerImage.getHeight() - 30);
	}
	 ...
	 *
	 * @return speedMultiplier The speed multiplier.
	 */
	...
	/**
	 * Returns whether or not the player has the oil spill debuff
	 *
	 * @return hasOilSpillDebuff true/false
	 */
	...
	/**
	 * Returns whether or not the player has flipped controls
	 * 
	 * @return isFlippedControls true/false
	 */
	...
	/**
	 * Move the player based on the current dx and dy values, taking into account
	 * flippedControls and speedMultiplier
	 */
	public void move() {
		if (!flippedControls) {
    ...
    /**
     * Places an oil spill obstacle at the player's current position if the 
     * player has the oil spill debuff.
     *
     * @return The`Obstacle object representing the oil spill, or null if 
     *         the player does not have the debuff.
     */
     ...
     * handling flipping based on the isLeft flag. Also renders the 
     * hitboxes for debugging purposes.
     *
	...
	/** Toggle the flippedControls state of the player */
